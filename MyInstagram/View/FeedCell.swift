...
class FeedCell: UICollectionViewCell {
    ...
    private lazy var usernameButton: UIButton = {
        ...
        button.setTitle("Sid", for: .normal)
    ...
    private let postImageView: UIImageView = {
        ...
        iv.clipsToBounds = true
        iv.isUserInteractionEnabled = true
        iv.image = UIImage(imageLiteralResourceName: "Tofu")
        return iv
    ...
    private let captionLabel: UILabel = {
        let label = UILabel()
        label.text = "Mmmmm, yummy tofu simmering in mom's famous sauce"
    ...
    override init(frame: CGRect) {
        ...
        // Optional to add this next line of code if adjusting the images using the sizing in 'extension FeedController UICollectionViewDelegateFlowLayout':
